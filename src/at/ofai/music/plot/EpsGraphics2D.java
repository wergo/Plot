 ...
 * href="http://www.jibble.org/">http://www.jibble.org/</a> Adapted by Werner
 * Goebl, <a href="http://iwk.mdw.ac.at/goebl/">mdw</a>
 */
public class EpsGraphics2D extends java.awt.Graphics2D {
        ...
        if (s instanceof BasicStroke) {
            ...
            if (dashArray != null) {
                for (int i = 0; i < dashArray.length; i++) {
                    dashes.append(dashArray[i]).append(" ");
                }
            }
            dashes.append("]");
    ...
    public java.awt.Rectangle getClipBounds() {
        ...
        java.awt.Rectangle rect = getClip().getBounds();
        return rect;
    }
    ...
    public void setClip(int x, int y, int width, int height) {
        setClip(new java.awt.Rectangle(x, y, width, height));
    }
    ...
    public void fillRect(int x, int y, int width, int height) {
        Shape shape = new java.awt.Rectangle(x, y, width, height);
        draw(shape, "fill");
    }
    ...
    public java.awt.Rectangle getClipBounds(java.awt.Rectangle r) {
        ...
        java.awt.Rectangle rect = getClipBounds();
